...
class ProductAssembly extends PureComponent {
  addToCart = () => {
  ...
  render() {
    ...
    const classesButton = cn(css.buttonLarge, {
      [css.buttonLarge_disabled]: hasInCart,
    });
    ...
    return (
      <div className={css.container}>
        ...
        <div className={classesButton}>
          <Button w100 handleClick={this.addToCart}>{hasInCart ? 'Добавлено' : 'Добавить'}</Button>
        </div>
      </div>
    );
  }
